Doorkeeper.configure do
  ...
  resource_owner_authenticator do
    ...
    # 保存请求参数，登录后需要重新把这个参数与加上{"client_id"=>"7d1709d41ab884000876c88db496c7df9f8c0c3dccc6b5c0aada5a2bfe33aa63", "redirect_uri"=>"http://localhost:3001/auth/doorkeeper/callback", "response_type"=>"code", "state"=>"d2f514df9c7b6bf38974481e9a20563a7327aca60cf4292c", "controller"=>"doorkeeper/authorizations", "action"=>"new"}
    session[:oauth_params] = params
    User.find_by_id(session[:user_id]) || redirect_to(app_oauth_login_url)
  end
